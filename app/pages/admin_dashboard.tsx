...
const Admin_dashboard = () => {
    ...
    return (
        <div className='relative w-full  flex items-start justify-center p-[10px] 'style={{height: 'calc(100vh - 60px)'}}  >
            ...
            {admin_dash.recent_users ? <div className="w-full flex flex-col justify-start items-center gap-[10px] ">

                {/* section one metrics card */}
                <div className="w-full flex justify-between gap-[10px] sm:gap-10">
                    <div className="bg-white w-[45%] h-[105px] rounded-[5px]  p-[25px] shadow-md flex flex-col items-center justify-center gap-5 border border-slate-100">
                ...
                <div className="bg-white w-full flex flex-col items-start justify-start shadow-lg rounded-[5px] border border-slate-100">
                    <span className="h-[45px] w-full flex items-center justify-start px-[15px] ">
                        <p className="text-md font-[500] ">Recent Tasks</p>
                    </span>
                    ...
                    <div className="w-full overflow-x-auto">
                        <div className="min-w-[1024px] px-[15px] py-[10px] flex flex-col items-start justify-start mx-auto ">
                            <span className="w-full h-[45px] flex items-center justify-between bg-blue-500 text-white rounded-[3px]">
                                ...
                                <p className="text-sm w-[15%] px-[15px] ">Stage</p>
                                    ...
                                    {admin_dash?.recent_tasks.map((data: any, ind: number)=>{
                                        ...
                                        return(
                                            <span key={ind} className=" table-body-row-1  " >
                                                ...
                                                <span className="w-[17.5%] px-[15px] flex items-end justify-start overflow-visible ">
                                                ...
                                                <span className={`w-[15%] px-[15px] flex items-center justify-start gap-[5px] text-sm`}> {formated_stage} </span>
                                                ...
                                                <span className=" w-[15%] px-[15px] flex items-center justify-start gap-[10px]" >
                                                    <button className="px-[17.5px] h-[27.5px] text-sm rounded-[2.5px] text-white bg-sky-500 hover:bg-sky-600" onClick={()=> handle_view(data)} >View</button>
                                                    {/* <button className="px-[17.5px] h-[27.5px] text-sm rounded-[2.5px] text-white bg-amber-600 hover:bg-amber-700" onClick={()=> handle_edit(data)} >edit</button> */}
                                                    <button className="px-[17.5px] h-[27.5px] text-sm rounded-[2.5px] text-white bg-red-600 hover:bg-red-700" onClick={()=> handle_task_delete(data)}>Delete</button>
                                                </span>
